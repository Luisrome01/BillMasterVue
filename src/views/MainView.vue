			...
			<div class="MainContentContainer">
				<div class="MainContentTop">
					...
					<div class="MainUserDiv">
						...
						<p v-else>Bienvenido Usuario</p>
					</div>
				</div>
				<div class="FactContentBottom">
					<component
						:is="componenteActivoComponente"
						:productList="productList"
						:montoTotal="monto"
						:cliente="cliente"
						@updateList="handleUpdateProductList"
						@checkout="handleCheckout"
						@clienteEncontrado="handleCliente"
						@metodo-pago="handlerCambioVista"
					></component>
				</div>
			</div>
		</div>
...
export default {
	...
	methods: {
		...
		handlerCambioVista() {
			this.actualizarComponenteActivo("Métodos de Pago");
		},
	},
	mounted() {
