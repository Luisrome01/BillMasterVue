  ...
  <div class="FacturaContainer">
      ...
      <div class="FacturaInput1">
        <div class="FacturaCedula-nombre">
          <div class="FacturaCedula">
            <InputDinamico :value="getValorIdentificacion" name="Cedula o Pasaporte:" color="#D9D9D9" width="200px"
              @blur="handleOnBlur" @onTypeChange="newType => setIdentificacion(newType)"
              @onValueChange="newValue => setValorIdentificacion(newValue)" />
          </div>

          <div class="FacturaNombre">
            <InputDiferente :value="getValorNombre" name="Nombre:" color="#D9D9D9" width="50%"
              placeholder="ej. Jhon Doe" @change="newName => setName(newName)" :disabled="disabledInput" />
          </div>
        </div>
        ...
        <div class="FacturaRif-BotonCrear">
          <div class="FacturaRif">
            <InputDiferente :value="getValorRif" name="Rif:" color="#D9D9D9" width="80%" placeholder="ej. J123456789"
              :disabled="disabledInput" @change="newRif => setRif(newRif)" />
          </div>
      ...
      <div class="FacturaInput2">
        <div class="FacturaoCodigo-buscar">
          <div class="FacturaCodigo">
            <InputDiferente :value="getValorCodigo" name="Codigo:" color="#D9D9D9" @change="newValue => {
              setCodigo(newValue);
        ...
        <div class="FacturaCantidad">
          <InputDiferente :value="getValorCantidad" type="number" name="Cantidad:" color="#D9D9D9" width="80px"
            placeholder="1" @change="newCantidad => {
    ...
    <div class="FacturaCheckoutContainer">
      <div style="display: flex; flex-direction: column;">
        ...
        <p style="position: relative; margin-left: auto; font-size: 25.4331px; font-weight: bold;">$ {{ montoTotal }}
        </p>
      </div>
